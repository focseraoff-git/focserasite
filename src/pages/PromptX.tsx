...
// 🔥 STORE ORDER ID (VERY IMPORTANT)
localStorage.setItem("promptx_order_id", data.orderId);
  ...
  <p className="text-sm text-gray-600">
    Workshop Fee: ₹149 <br />
    Payment Gateway Fee: <strong>1.6%</strong> <br />
    <strong className="text-gray-900">Total Payable: ₹152</strong>
  </p>
</div>
