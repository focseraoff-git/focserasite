...
const LoginPage = ({ onLogin, onBack }) => {
    ...
    const handleAuth = async (e) => {
        ...
        if (error) {
            ...
            // On successful email/password login, call onLogin to proceed
            onLogin();
        }
    };
...
export default function App() {
    ...
    const handleBookNow = (service, addOns, price) => {
        ...
        // Save the package to session storage before redirecting to login
    ...
    const resetToLanding = () => {
        ...
        // Clean up session storage on manual reset
        sessionStorage.removeItem('focseraBookingPackage');
    };
