...
const TIER_OPTIONS = [
    ...
    },
    {
        ...
        gradient: 'from-[#F97316] via-[#FED7AA] to-[#C2410C]'
    }
];
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {phase === 1 && (
                            <motion.div key="phase1" custom={direction} variants={variants} initial="enter" animate="center" exit="exit" className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {[
                                    ...
                                    <div key={option.id} onClick={() => setFormData(prev => ({ ...prev, intent: option.id as IntentType }))} className={`relative p-8 rounded-[2rem] border transition-all duration-500 cursor-pointer group overflow-hidden backdrop-blur-xl ${formData.intent === option.id ? 'border-[#FB923C] bg-white/[0.08] shadow-[0_0_50px_rgba(212,175,55,0.15)] scale-[1.02]' : 'border-white/5 bg-white/[0.03] hover:bg-white/[0.06] hover:border-white/20 hover:scale-[1.01]'}`}>
                                        <div className="flex flex-col items-center text-center h-full justify-center relative z-10">
                                            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 transition-colors ${formData.intent === option.id ? 'bg-[#FB923C]/20 text-[#FB923C]' : 'bg-white/5 text-gray-400 group-hover:text-white'}`}>
                                                <option.icon size={32} />
                                            </div>
                                            <h3 className="text-xl font-bold text-white mb-2">{option.title}</h3>
                                            <p className="text-gray-400 text-sm font-light mb-6">{option.desc}</p>
                                            <div className={`w-6 h-6 rounded-full border flex items-center justify-center transition-all ${formData.intent === option.id ? 'bg-[#FB923C] border-[#FB923C]' : 'border-white/20'}`}>
                                                {formData.intent === option.id && <Check className="text-black" size={12} />}
                                            </div>
                                        </div>
                                    </div>
                                ))}
                ...
                {!submissionSuccess && (
                    <div className="flex justify-between mt-8">
                        ...
                        {phase < 4 ? (
                            <button onClick={handleNext} className="px-10 py-4 bg-gradient-to-r from-[#FED7AA] to-[#F97316] rounded-full font-bold text-black shadow-[0_0_40px_rgba(249,115,22,0.3)] hover:shadow-[0_0_60px_rgba(249,115,22,0.5)] hover:scale-105 transition-all duration-300 text-sm tracking-widest uppercase">Continue</button>
                        ) : (
                            <button onClick={handleSubmit} disabled={isSubmitting} className="px-10 py-4 bg-gradient-to-r from-[#FED7AA] to-[#F97316] rounded-full font-bold flex items-center gap-3 text-black shadow-[0_0_40px_rgba(249,115,22,0.3)] hover:shadow-[0_0_60px_rgba(249,115,22,0.5)] hover:scale-105 transition-all duration-300 text-sm tracking-widest uppercase">
                                {isSubmitting ? <Loader2 className="animate-spin" /> : 'Request Custom Quote'}
                            </button>
                        )}
                    </div>
                )}
...
export default function Interiors() {
    ...
    return (
        <div className="bg-[#020202] text-white font-sans selection:bg-[#FB923C]/30 selection:text-[#FB923C] relative overflow-x-hidden">
            <style>{`
                .text-gold { color: #FB923C; }
                .bg-gold { background-color: #FB923C; }
                .border-gold { border-color: #FB923C; }
                .glass-card {
            ...
            {/* Cinematic Noise Overlay & Ambient Light */}
            <div className="fixed inset-0 z-50 pointer-events-none opacity-[0.04] mix-blend-overlay" style={{ backgroundImage: 'url("https://grainy-gradients.vercel.app/noise.svg")' }}></div>
            <div className="fixed top-0 left-0 w-full h-[500px] bg-gradient-to-b from-[#FB923C]/5 to-transparent pointer-events-none z-0"></div>

            {/* 1. Hero Section + Calculator */}
            <section className="relative min-h-[auto] flex items-center justify-center bg-[#020202] overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32">
                {/* Dark Ambient Background - GoldShift */}
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-[-20%] left-[20%] w-[800px] h-[800px] bg-[#FB923C]/5 rounded-full blur-[150px] animate-pulse duration-[8000ms]"></div>
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
                    <div className="text-center mb-20 relative z-20">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 py-2 px-6 rounded-full bg-white/[0.03] border border-white/10 text-[#FB923C] text-xs font-medium tracking-[0.3em] uppercase backdrop-blur-md mb-8"
                        >
                        ...
                        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white mb-8 leading-[0.9]">
                            Vision <span className="text-white/20 italic">Before</span> <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#FED7AA] via-[#FB923C] to-[#F97316]">Creation</span>
                        </h1>
            ...
            <section className="py-20 md:py-32 bg-[#030303] border-y border-white/5 relative">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white tracking-tight">Who We Are</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                            Crafted with precision, our thoughtfully selected range guarantees ideal solutions, uniquely tailored to your Preferences and Budget.
                            <br /><br />
                            Comprising committed and imaginative professionals with a specialization in interior design, we embarked on our journey guided by a fundamental belief: well-designed spaces possess the ability to enrich lives. Throughout the years, our evolution has transformed us into a fully-fledged interior design firm, providing an extensive array of services to cater to the varied requirements of our clients.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
                        {[
                            ...
                            },
                            {
                                ...
                                bg: "bg-gradient-to-br from-[#FB923C]/10 to-black",
                                span: "md:col-span-2"
                            },
                            {
                                icon: Armchair,
                            ...
                            <motion.div whileHover={{ scale: 1.01 }} key={i} className={`${item.bg} ${item.span} p-10 rounded-[2.5rem] border border-white/5 hover:border-[#FB923C]/30 transition-all duration-700 group relative overflow-hidden flex flex-col justify-between shadow-2xl hover:shadow-[0_0_60px_rgba(249,115,22,0.1)] bg-black/40 backdrop-blur-md`}>
                                <div className="absolute inset-0 bg-gradient-to-t from-[#FB923C]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                                <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center text-[#FB923C] group-hover:scale-110 transition-transform duration-500 border border-white/5 relative z-10 group-hover:bg-[#FB923C]/20">
                                    <item.icon size={32} />
                                </div>
                                <div className="relative z-10">
                                    <h3 className="text-3xl font-bold mb-3 text-white group-hover:text-[#FED7AA] transition-colors">{item.title}</h3>
                                    <p className="text-gray-400 text-base leading-relaxed line-clamp-3 font-light">{item.desc}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
            ...
            <section className="py-20 md:py-32 bg-[#030303] relative overflow-hidden text-center md:text-left">
                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-20 relative z-10">
                    <div className="flex-1 order-2 md:order-1">
                        <span className="text-[#FB923C] font-bold tracking-[0.2em] text-xs uppercase mb-6 block">The Promise</span>
                        <h2 className="text-5xl md:text-8xl font-black mb-8 text-white tracking-tighter leading-none">
                            24-Hour <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FED7AA] via-[#FB923C] to-[#F97316]">Design Preview.</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 relative z-10">
                            {[
                                ...
                                <motion.div
                                    whileHover={{ y: -10 }}
                                    key={i}
                                    className="relative p-8 rounded-3xl bg-white/[0.03] border border-white/5 hover:border-[#FB923C]/50 hover:bg-white/[0.05] transition-all duration-500 group overflow-hidden shadow-2xl hover:shadow-[0_0_40px_rgba(249,115,22,0.1)]"
                                >
                                    <div className="absolute inset-0 bg-gradient-to-br from-[#FB923C]/0 to-[#FB923C]/0 group-hover:from-[#FB923C]/5 group-hover:to-transparent transition-all duration-500"></div>
                                    <div className="relative z-10 flex flex-col items-center text-center">
                                        <div className="w-24 h-24 rounded-full bg-[#0a0a0a] border-4 border-[#1a1a1a] group-hover:border-[#FB923C] flex items-center justify-center text-3xl font-black mb-6 shadow-xl relative transition-all duration-500 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.3)]">
                                            <span className="text-gray-700 group-hover:text-white transition-colors">{s.step}</span>
                                            <div className="absolute inset-0 rounded-full bg-[#FB923C]/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                        </div>
                                        <h3 className="text-2xl font-bold mb-2 group-hover:text-[#FED7AA] transition-colors">{s.title}</h3>
            ...
            <section className="py-20 md:py-32 bg-[#050505] text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        <div className="relative z-10">
                            <h2 className="text-5xl md:text-7xl font-bold mb-10 tracking-tighter">Why <br /><span className="text-[#FB923C]">Focsera?</span></h2>
                            ...
                            <div className="space-y-6">
                                {[
                                    { title: "Professional Crew", desc: "Urban Elegance Interiors combines expertise and professionalism, simplifying the process of expressing your interior needs and turning your dream home into a reality." },
                                    { title: "Quality You Can Trust", desc: "We uphold uncompromising standards in material quality, treating your home as if it were our own." },
                                    { title: "Feel The Upgrade", desc: "At Urban Elegance Interiors, we provide a touch of luxury to your home that surpasses belief." }
                                ].map((item, i) => (
                                    <div key={i} className="flex items-start gap-6 group p-4 -ml-4 rounded-2xl hover:bg-white/[0.02] transition-colors border border-transparent hover:border-white/5">
                                        <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#FB923C]/10 group-hover:border-[#FB923C]/50 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_25px_rgba(249,115,22,0.2)]">
                                            <Star className="text-gray-500 group-hover:text-[#FB923C] transition-colors" size={24} />
                                        </div>
                                        <div>
                                            <h4 className="text-xl font-bold text-white mb-1 group-hover:text-[#FED7AA] transition-colors">{item.title}</h4>
            ...
            <section className="py-32 bg-[#050505] relative overflow-hidden border-t border-white/5">
                ...
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FB923C]/10 blur-[120px] rounded-full pointer-events-none opacity-50"></div>
                <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-purple-900/10 blur-[120px] rounded-full pointer-events-none opacity-50"></div>
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="text-center mb-24">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs font-bold tracking-[0.2em] uppercase mb-8 text-gray-400 backdrop-blur-md"
                        >
                        ...
                        >
                            Focsera <span className="italic text-[#FB923C]">Living</span>
                        </motion.h2>
                        <p className="text-xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed">
                            A curated collection of bespoke statement pieces. <br className="hidden md:block" />Designed to be the soul of your space.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="md:col-span-8 group relative rounded-[3rem] overflow-hidden bg-white/5 border border-white/10"
                    >
                        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-80 group-hover:scale-105 transition-all duration-1000"></div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent"></div>

                        <div className="absolute bottom-0 left-0 w-full p-10 md:p-14 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                            <div className="flex items-center gap-4 mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                                <span className="px-3 py-1 rounded-full border border-white/20 text-[10px] uppercase tracking-wider text-white bg-black/50 backdrop-blur-md">Italian Leather</span>
                                <span className="px-3 py-1 rounded-full border border-white/20 text-[10px] uppercase tracking-wider text-white bg-black/50 backdrop-blur-md">Handcrafted</span>
                            </div>
                            <div className="flex justify-between items-end">
                                <div>
                                    <h3 className="text-4xl md:text-5xl font-bold text-white mb-2 italic">The Cloud Sofa</h3>
                                    <p className="text-gray-400">Modular comfort for the modern sanctuary.</p>
                                </div>
                                <button className="hidden md:flex items-center gap-2 text-black bg-[#FB923C] px-6 py-3 rounded-full font-bold uppercase text-xs tracking-widest hover:bg-white transition-colors">
                                    View Details
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="md:col-span-4 flex flex-col gap-6">
                        ...
                        <motion.div
                            ...
                            className="flex-1 group relative rounded-[2.5rem] overflow-hidden bg-white/5 border border-white/10"
                        >
                            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-80 group-hover:scale-105 transition-all duration-1000"></div>
                            <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>

                            <div className="absolute bottom-0 left-0 w-full p-8">
                                <h3 className="text-2xl font-bold text-white mb-1">Accent Chairs</h3>
                                <p className="text-sm text-gray-400 mb-4 opacity-80">Statement pieces.</p>
                                <button className="text-[#FB923C] text-xs font-bold uppercase tracking-widest border-b border-[#FB923C] pb-1">Explore</button>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex-1 group relative rounded-[2.5rem] overflow-hidden bg-white/5 border border-white/10"
                        >
                            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-80 group-hover:scale-105 transition-all duration-1000"></div>
                            <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent"></div>

                            <div className="absolute bottom-0 left-0 w-full p-8">
                                <h3 className="text-2xl font-bold text-white mb-1">Lamps & Decor</h3>
                                <p className="text-sm text-gray-400 mb-4 opacity-80">Illuminating details.</p>
                                <button className="text-[#FB923C] text-xs font-bold uppercase tracking-widest border-b border-[#FB923C] pb-1">Explore</button>
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 space-y-32">
                    ...
                    <div className="text-center relative">
                        ...
                        <h3 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter relative z-10">
                            Ready to see <span className="text-green-500 italic">your</span> home?
                        </h3>
                    ...
                    <div className="text-center pt-16 border-t border-white/5">
                        <p className="italic text-2xl text-gray-500 mb-6">
