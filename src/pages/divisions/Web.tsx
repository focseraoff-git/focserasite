    ...
    <div className="min-h-screen bg-white pt-20">
      <section className="relative py-24 bg-gradient-to-br from-[#0052CC] to-[#0066FF] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="w-32 h-32 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl p-4">
            <img src="/images/logos/FocseraWeb.jpg" alt="Focsera Web" className="w-full h-full object-contain" />
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Focsera Web</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Building digital experiences that drive results. Modern web solutions for businesses of all sizes.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#ECECEC]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Build Your Digital Presence?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Let's create a website or web application that takes your business to the next level.
          </p>
          <Link
            to="/contact"
