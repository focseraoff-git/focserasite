...
import { Package, Palette, TrendingUp, ArrowRight } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Comprehensive design services including UI/UX, packaging design, and concept development for your products.',
      features: ['UI/UX Design', 'Packaging Design', 'Concept Development', 'Brand Identity']
    },
    {
      icon: Package,
      ...
      features: ['3D Visualization', 'Prototyping', 'Technical Rendering', 'Product Animation']
    },
    {
      icon: TrendingUp,
      ...
      features: ['Launch Strategies', 'Digital Campaigns', 'E-commerce Integration', 'B2B/B2C Sales Support']
    }
  ];
