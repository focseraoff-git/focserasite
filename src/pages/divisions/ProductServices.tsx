...
export default function ProductServices() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: dbError } = await supabase.from('dine_qr_requests').insert({
